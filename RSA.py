...
from functions import isPrime, factorization, inversion, extendedEuclidianAlgirithmInversion, signCheck, threaded_factorization
...
with yaspin(text="Finding primes...", color="yellow") as spinner:
    factors, factorization_time = threaded_factorization(modulo)
